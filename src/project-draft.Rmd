...
#   group_by(FirstAcadYear, CONTACT_REASON1_NAME) |>
#   summarize(n = n()) |>
#   arrange(FirstAcadYear, desc(n))
# 
...
# 
# ggplot(top_5_contact_reason_counts, aes(x = factor(FirstAcadYear), y = n, fill = CONTACT_REASON1_NAME)) +
#   geom_bar(stat = "identity", position = "stack") +
...
# 
# total_contacts <- data %>%
#   filter(CONTACT_TYPE_NAME == "Appointment", contact_year > 2010 & contact_year < 2024) %>%
